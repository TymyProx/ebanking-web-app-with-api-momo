          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-[1.5vw]">
            <div className="sm:col-start-3 flex justify-center sm:justify-end mt-8 sm:mt-0">
              <div className="relative group w-full max-w-[90%] sm:max-w-[85%] lg:max-w-[28vw] lg:min-w-[360px]">
                <div className="absolute inset-0 bg-gradient-to-br from-[#2d6e3e]/30 via-[#f4c430]/20 to-[#2d6e3e]/30 rounded-2xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity" />
              ...
              <div className="relative bg-white/75 backdrop-blur-xl rounded-xl shadow-lg p-3 sm:p-4 lg:p-[1.2vw] hover:shadow-xl hover:-translate-y-1 hover:bg-white/85 transition-all duration-300 border border-white/40 overflow-hidden">
                ...
                <div className="flex items-center space-x-3 relative z-10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs lg:text-[clamp(0.65rem,0.75vw,0.9rem)] text-gray-700 font-medium mt-0.5 drop-shadow-sm">Notre équipe est à votre disposition</p>
                  </div>
                </div>
              </div>
            </Link>
              ...
              <div className="relative bg-white/75 backdrop-blur-xl rounded-xl shadow-lg p-3 sm:p-4 lg:p-[1.2vw] hover:shadow-xl hover:-translate-y-1 hover:bg-white/85 transition-all duration-300 border border-white/40 overflow-hidden">
                ...
                <div className="flex items-center space-x-3 relative z-10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs lg:text-[clamp(0.65rem,0.75vw,0.9rem)] text-gray-700 font-medium mt-0.5 drop-shadow-sm">Assistance disponible 24/7</p>
                  </div>
                </div>
              </div>
            </Link>

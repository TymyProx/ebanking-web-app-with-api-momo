...
import { User, Mail, MapPin, CreditCard, HelpCircle, UserPlus, ArrowLeft } from "lucide-react"
...
const signupMessages = [
  {
    title: "Rejoignez la famille BNG CONNECT",
    ...
    <div className="min-h-screen lg:h-screen relative overflow-x-hidden overflow-y-auto lg:overflow-hidden">
      ...
      <div className="absolute lg:fixed inset-0 z-0 min-h-screen lg:min-h-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#2d6e3e] via-[#36803e] to-[#2d6e3e]">
          ...
          {/* Banking illustration - ~50% viewport */}
      ...
      <main className="w-full px-5 pb-10 min-[400px]:px-6 sm:px-6 sm:pb-8 lg:px-[2vw] lg:pb-[1.5vw] relative z-10 min-h-screen lg:h-screen flex flex-col justify-between [padding-left:max(1.25rem,env(safe-area-inset-left))] [padding-right:max(1.25rem,env(safe-area-inset-right))] [padding-top:calc(env(safe-area-inset-top,0px)+25rem)] max-[380px]:[padding-top:calc(env(safe-area-inset-top,0px)+31rem)] sm:[padding-top:calc(env(safe-area-inset-top,0px)+28rem)] md:[padding-top:calc(env(safe-area-inset-top,0px)+28.5rem)] lg:pt-[2vw]">
